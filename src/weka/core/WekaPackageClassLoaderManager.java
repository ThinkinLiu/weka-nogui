...
public class WekaPackageClassLoaderManager {
  ...
  protected Map<String, WekaPackageLibIsolatingClassLoader> m_packageJarClassLoaders =
    new HashMap<String, WekaPackageLibIsolatingClassLoader>();
  ...
  protected static void injectClasses(InputStream jarStream,
    ...
    List<byte[]> okBytes = new ArrayList<byte[]>();
    List<String> okClasses = new ArrayList<String>();
    ...
    if (preloadClassByteCode.size() > 0) {
      ...
      List<byte[]> failedToInject = new ArrayList<byte[]>();
      List<String> classesF = new ArrayList<String>();
      boolean cont = true;
      ...
      try {
        do {
          ...
          failedToInject = new ArrayList<byte[]>();
          classesF = new ArrayList<String>();
